...
const SignUp = ({ onSwitchMode, onSubmit }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.token) {
        // ✅ Store token so Layout can fetch tasks immediately
      ...
      // Update app-level user state if handler provided
      ...
      // Either go to login page or dashboard (App's onSubmit already navigates)
      if (!onSubmit && onSwitchMode) {
        // fallback: switch to login if App didn't pass onSubmit
